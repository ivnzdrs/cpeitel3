  ...
  return (
    <div className="App">
      ...
      <div className="CalcContainer">
        ...
        <div className="SentenceButtonsContainer">
          <button onClick={() => setDisp("Consistency over time shapes success.")}>What I learned?</button>
          <button onClick={() => setDisp("How to turn challenges into opportunities.")}>What I want to learn?</button>
          <button onClick={() => setDisp("By embracing failure as feedback.")}>How will I learn?</button>
        </div>
